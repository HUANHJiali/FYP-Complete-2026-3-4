<template>
	<div class="fater-body-show">
        ...
        <Modal v-model="showAddFlag"
			title="信息编辑" ok-text="提交" cancel-text="取消" @on-ok="handleAddOk">
			<Form ref="addForm" :label-width="80" :model="collegeForm" :rules="rules">
        ...
        <Modal v-model="showUpdFlag"
			title="信息编辑" ok-text="提交" cancel-text="取消" @on-ok="handleUpdOk">
			<Form ref="updForm" :label-width="80" :model="collegeForm" :rules="rules">
				<FormItem label="学院名称" prop="name">
					<Input v-model="collegeForm.name" placeholder="请输入学院名称..."></Input>
				</FormItem>
			</Form>
